...
class WaveformTest < Test::Unit::TestCase
  ...
  def test_generates_phonocardiogram_waveform_via_passed_data
    Waveform.generate(fixture("phonocardiogram_sample.wav"), output("phonocardiogram_array_sample.png"), :type => :phonocardiogram, :array => [-0.052887, -0.074229, -0.094981, -0.100566, -0.090027, -0.084483, -0.088877, -0.088816, -0.089976, -0.090607, -0.085347, -0.075551, -0.056081, -0.033030, -0.011159, 0.008809, 0.016886, 0.017008])
